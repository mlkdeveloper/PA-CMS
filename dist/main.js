...
function sliderInit(slider) {
  ...
  container.children('img').addClass('slide'); // Ajouter le container de slides au slider
  ...
  slider.append(nav);
  slider.attr('data-currentSlide', '0'); // Ajouter un écouteur de clic sur les bouton prev et next
