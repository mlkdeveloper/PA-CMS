        ...
        if(!empty($_POST)){
            ...
            if(empty($errors)) {
                ...
                if ($pwd == $pwdConfirm) {
                    ...
                    Email::sendEmail($email, "Veuillez confirmer votre compte", "http://".$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT']."/confirmation-inscription?tkn=".$token,"Confimer mon compte", "/");
            ...
            if (empty($error)) {
                ...
                if ($message != false){
                    ...
                    if($formStatus == Database::NEW_OBJECT){
                        Email::sendEmail($client->getEmail(), "Veuillez confirmer votre compte", "http://".$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT']."/confirmation-inscription?tkn=".$token,"Confirmer mon compte", "/admin/liste-client");
                    }
                }else{
    ...
    public function addUsersAction(){
        ...
        if(!empty($_POST)) {
            ...
            if (empty($errors)) {
                ...
                Email::sendEmail($user->getEmail(), "Veuillez confirmer votre compte", "http://".$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT']."/confirmation-inscription?tkn=".$token,"Confirmer mon compte", "/admin/dashboard");
