                    ...
                    <form method="POST" action="/update-settings">
                        ...
                        <div class="row">
                            <div class="form_align--top center-margin">
                                ...
                                <input class="input" type="email" id="smtp_mail" name="smtp_mail" required
                        ...
                        <div class="row">
                            <div class="form_align--top center-margin">
                                ...
                                <input class="input" type="text" id="smtp_password" name="smtp_password" required
                        ...
                        <div class="row">
                            <div class="form_align--top center-margin">
                                ...
                                <input class="input" type="text" id="smtp_host" name="smtp_host" required
                        ...
                        <div class="row">
                            <div class="form_align--top center-margin">
                                ...
                                <select class="input" id="smtp_auth" name="smtp_auth">
                        ...
                        <div class="row">
                            <div class="form_align--top center-margin">
                                ...
                                <input class="input" type="text" id="smtp_port" name="smtp_port" required
                                       placeholder="587"
                        ...
                        <div class="row">
                            <div class="form_align--top center-margin">
                                ...
                                <textarea name="public_key" class="input"
                        ...
                        <div class="row">
                            <div class="form_align--top center-margin">
                                ...
                                <textarea name="private_key" class="input"
